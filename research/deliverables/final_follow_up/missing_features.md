...
| 4 | Should soft delete be implemented? | MEDIUM |
...
| # | Question | Priority |
|---|----------|----------|
| 1 | Should these issues be fixed or preserved for compatibility? | HIGH |
| 2 | Is there a data migration strategy for guest boolean? | HIGH |
| 3 | Should unique constraint be added on reactions? | MEDIUM |

---

## Priority Summary

| Feature | Priority | Blocking Implementation? |
|---------|----------|----------------------------|
