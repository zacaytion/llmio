...
The real-time architecture was documented in `research/synthesis/realtime_architecture.md` but **was not included in the third-party follow-up investigation**. This document captures open questions that need clarification before Go implementation.
...
Go must produce identical JSON structure for channel server compatibility.
